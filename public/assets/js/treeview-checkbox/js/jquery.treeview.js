function TreeView(datas, options) {
    ...
    function checkControlParents() {
        ...
        for (var index = 1 ; index < $parents.length ; index++) {
            ...
            var item = $(el).find(">.item").get(0);
            var $children = $(el).find(".group .item");
            var all1 = true;
            var all0 = true;
    ...
    function setCheckState(value) {
        ...
        if (value == 1) {
            $(this).find(">[check-icon]")[0].className = "far fa-check-square";
        }
        if (value == 2) {
            $(this).find(">[check-icon]")[0].className = "far fa-minus-square";
        }
    }
    ...
    function createSingleItem(data) {
        ...
        item.className = "item treeview-item";
        ...
        if ("disabled" in options && options.disabled === true) {
